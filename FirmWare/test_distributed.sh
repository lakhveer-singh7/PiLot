...
MODEL_CONFIG="$SCRIPT_DIR/configs/model_config_nrf52840_realistic.json"
DATASET="Cricket_X"
...
"$DEVICE_BIN" --id=0 --role=head --dataset="$DATASET" \
...
"$DEVICE_BIN" --id=6 --role=tail --classes=12 \
